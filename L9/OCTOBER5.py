...
cv2.rectangle(image_rgb,top_left1, bottom_right,(0,255,255),3)
...
cv2.putText(image_rgb, "Region 2", (top_left1[0], top_left1[1] -10), font,0.7,(255,0,255),2,cv2.LINE_AA)
cv2.putText(image_rgb, "Center 1", (center1_x - 40, center1_x + 40), font,0.6,(0,255,0), 2,cv2.LINE_AA)
cv2.putText(image_rgb, "Center 2", (center2_y - 40 ,center1_y +40), font,0.6,(0,0,255) ,2 ,cv2.LINE_AA )
...
cv2.arrowedLine(image_rgb, arrow_end, arrow_start, (255,255,0),3, tiplLength=0.05)
